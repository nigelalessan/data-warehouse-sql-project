...
DDL pada Schema Silver
==================================================================

Script Purpose: 
	Script ini digunakan untuk melakukan DDL untuk membuat table 
	pada schema silver yang berasal dari schema bronze yang nantinya
	akan dilakukan data cleaning, serta terdapat penambahan column
	yang digunakan sebagai metadata dari table tersebut.
	
	mencakup datasets dari kelompok CRM 
